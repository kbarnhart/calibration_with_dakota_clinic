#! /usr/bin/env python
"""Basic Model Interface implementation for a 1D heat model."""
...
class BmiHeat(Bmi):
    ...
    """Solve the heat equation for a 1D column."""
    ...
    def initialize(self, filename=None):
        ...
        self._var_units = {"temperature": "K"}
        self._var_loc = {"temperature": "node"}
        self._grids = {0: ["temperature"]}
